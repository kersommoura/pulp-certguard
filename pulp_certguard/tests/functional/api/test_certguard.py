...
class CertGuardTestCase(unittest.TestCase):
    """API tests for certguard.

    This test case targets the following issues:


    * `Pulp #3969 <https://pulp.plan.io/issues/3969>`_.
    * `Pulp #3970 <https://pulp.plan.io/issues/3970>`_.
    * `Pulp #4122 <https://pulp.plan.io/issues/4122>`_.
    """
    ...
    def setUpClass(cls):
        ...
        Prepare artifacts (ca and client certs)
